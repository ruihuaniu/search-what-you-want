...
function SearchBar(props) {
  ...
  const {
    products, setProducts, category, setCategory, data,
      ...
      try {
        ...
        switch (category) {
          ...
          case 'joke':
            ...
            break;
          default:
            console.error('Error, case is not found');
        }
  ...
  const handleSubmit = (e) => {
    ...
    switch (category) {
      case 'product':
        ...
        const result = data.filter((item) => item.title.toLowerCase().includes(inputFormatted));
  ...
  return (
    <div className={location.pathname === pathName.home ? 'searchBar-container homepage-searchBar' : 'searchBar-container'}>
      ...
      <form className="searchBar-form" onSubmit={handleSubmit}>
        ...
        <input
          type="text"
          className={isValid ? 'search-input ' : 'search-input validate-error'}
